<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FindResult.aspx.cs" Inherits="FindResult" %>

<%@ PreviousPageType VirtualPath="FindCond.aspx" %>
...
<body background="../Images/defaultbg.png">
    ...
    <div align="center">
            ...
            <ContentTemplate>
                <wc:GridViewExt ID="ObjGrid" runat="server" OnItemRowBound="ObjGrid_ItemRowBound" OnSorting="ObjGrid_Sorting" ObjID="UserID" MulSelect="true" Width="98%">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="出生地" DataField="csd" />
                        <asp:BoundField HeaderText="手机" DataField="sj" />
                        
                        <asp:BoundField HeaderText="应聘者来源" DataField="ypzly" />
        ...
        <asp:Button ID="btnBack" runat="server" Text="返 回" CausesValidation="false" OnClick="btnBack_Click" UseSubmitBehavior="false" />
        <br />
        <br />
