...
public partial class GzsxEdit : System.Web.UI.Page
{
    ...
    private void FillNewForm()
    {
        ...
        WebHelper.FillEnuList(gzsxlb, db, typeof(enuGzsxlb), false, "");
    ...
    protected void btnNew_Click(object sender, EventArgs e)
    {
        try {
            ...
            WebHelper.WriteScript("window.parent.frames[0].location.href='GzsxList.aspx';window.parent.frames[0].location.reload();", ClientScript);
        }
        catch (Exception ex) {
